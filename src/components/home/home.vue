            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
              <g id="Page-1" fill="none" fill-rule="evenodd">
                <g id="Course-Template">
                  ...
                  <g id="ep-content" class="ep-svg-block" transform="translate(229 56)">
                  ...
                  <g id="ep-form" class="ep-svg-block" transform="translate(244 140)">
                  ...
                  <g id="ep-media" class="ep-svg-block" transform="translate(239 224)">
                  ...
                  <g id="ep-unity" class="ep-svg-block" transform="translate(241 496)">
                  ...
                  <g id="ep-elements" class="ep-svg-block" transform="translate(66 357)">
                    ...
                    <text
                      ...
                      letter-spacing="1"
                    >
                      <tspan x="36.046" y="33">ELEMENTS OF</tspan>
                      <tspan x="65.559" y="54">DESIGN</tspan>
                    </text>
                  </g>
                  <g id="ep-principles" class="ep-svg-block" transform="translate(335 357)">
                    <rect id="Rectangle" width="200" height="74" fill="#8BE5AD" rx="37" />
                    <text
                      ...
                      letter-spacing="1"
                    >
                      <tspan x="30.707" y="33">PRINCIPLES OF</tspan>
                      <tspan x="30.196" y="54">ORGANIZATION</tspan>
                    </text>
                  </g>
                </g>
              </g>
